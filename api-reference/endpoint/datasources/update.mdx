...
api: 'POST https://app.fiscalohq.com/api/datastores/update/{datastoreId}'
...
curl --location --request POST 'https://app.fiscalohq.com/api/datastores/update/<datastoreId>' \
