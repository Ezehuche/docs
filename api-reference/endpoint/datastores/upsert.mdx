...
api: 'POST https://app.fiscalohq.com/api/datastores/upsert/{datastoreId}'
...
curl --location --request POST 'https://app.fiscalohq.com/api/datastores/upsert/<datastoreId>' \
