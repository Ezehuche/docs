...
api: 'POST https://app.fiscalohq.com/api/datastores/file-upload/generate-link/{datastoreId}'
...
curl --location --request POST 'https://app.fiscalohq.com/api/datastores/file-upload/generate-link/<datastoreId>' \
