...
api: 'POST https://app.fiscalohq.com/api/datastores/query/{datastore_id}/old'
...
curl --location --request POST 'https://app.fiscalohq.com/api/datastores/<datastore_id>/query' \
