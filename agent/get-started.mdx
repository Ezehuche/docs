...
Getting started with fiscalo Agents is easy!
Just follow the steps below and you'll be up and running in no time.

<Steps>
  <Step title="Create an Agent">
    Go to the [Agents](https://app.fiscalohq.com/agents) page. Create a new Agent
    and configure it.
  </Step>
  <Step title="Add Knowledge">
    Create a [Datastore](https://app.fiscalohq.com/datastores) and connect it to
